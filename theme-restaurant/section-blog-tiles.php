...
<section id="section-<?php echo $rf_section_post->ID; ?>" class="section blogtiles <?php if (isset($rf_section_parallax) && $rf_section_parallax != '') { echo 'parallax'; } ?>" style="<?php echo $rf_section_style; ?>">
    ...
    <div class="container" style="margin-top:<?php if (isset($rf_section_margintop)) echo str_replace('px','',$rf_section_margintop); ?>px;margin-bottom:<?php if (isset($rf_section_marginbottom)) echo str_replace('px','',$rf_section_marginbottom); ?>px;">
        ...
        <div class="row">
            ...
            $rf_posts = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => $rf_blog_maxposts, 'order' => 'DESC', 'cat' => $rf_blog_categories, 'paged' => $paged ) );
                        ...
                        <figure>
                            ...
                            <figcaption>
                            	...
                            	<div class="button-container">
                                	<a class="button" href="<?php the_permalink() ?>"><?php _e('View', 'the-restaurant'); ?></a>
                                </div>
                                ...
                                <div class="blog-content-hover">
                                	...
                                	<div class="blog-author" style="color:#<?php if (isset($rf_section_textcolor) && $rf_section_textcolor != '') echo str_replace('#','',$rf_section_textcolor); ?>;">
                                        ...
                                        <?php _e('By ', 'the-restaurant'); the_author(); ?>
                                    </div>
