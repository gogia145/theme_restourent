...
<section id="section-<?php echo $rf_section_post->ID; ?>" class="section widgets <?php if (isset($rf_section_parallax) && $rf_section_parallax != '') { echo 'parallax'; } ?>" style="<?php echo $rf_section_style; ?>">
